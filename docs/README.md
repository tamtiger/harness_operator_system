...
> Hướng dẫn chi tiết sử dụng harness-os v1.7.0 — hệ thống harness operator chạy local cho agentic coding.
...
| 🧰 **[05. Danh mục Tools](./05-tools-reference.md)** | Hướng dẫn chi tiết các tools MCP. |
| 💻 **[06. Lệnh CLI](./06-cli-reference.md)** | Chi tiết cách gọi các lệnh `harness cli`. |
...
*Tài liệu cập nhật cho harness-os v1.7.0.*
